...
export declare const ERROR_STATES: readonly [SessionState.ERROR_VAST, SessionState.ERROR_MEDIA, SessionState.ERROR_NETWORK, SessionState.ERROR_TIMEOUT];
...
export type TrackingEventType = 'impression' | 'start' | 'firstQuartile' | 'midpoint' | 'thirdQuartile' | 'complete' | 'error';
